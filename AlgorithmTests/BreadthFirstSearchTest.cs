...
{
    [TestClass]
    public class BreadthFirstSearchTest : AGraphTest
    {
        [TestMethod]
        public void BFSTest_GermanyGraph()
        {
            ...
            var path = BreadthFirstSearch.Search(g, Frankfurt, Muenchen, true);
        ...
        [TestMethod]
        public void BFSTest_GermanyGraph_Matching()
        {
            var g = InitGermanyGraph();
            ...
            var path = BreadthFirstSearch.Search(g, Frankfurt, Muenchen, true, (v => !v["name"].Equals("Kassel")));
        ...
        [TestMethod]
        public void BFSTest_Barabasi_100_Vertices()
        {
            ...
            var path = BreadthFirstSearch.Search(g, n0, n99, true);
